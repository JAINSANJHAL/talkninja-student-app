...
export default function App() {
  ...
  return (
    ...
    >
      {/* Screen switcher */}
      <div className="flex gap-2 bg-white rounded-2xl p-1.5 shadow-sm" style={{ border: '1px solid #E8F5EA' }}>
      ...
      {/* Phone */}
      <PhoneFrame>
        {screen === 'home'     && <HomeScreen onStart={() => setScreen('results')} onNavigate={setScreen} />}
